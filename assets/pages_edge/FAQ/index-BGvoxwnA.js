import{n as l,j as d,a as r}from"../../vendor_emotion-nEVkPYdj.js";import{c as s,C as c}from"../../components-DVpIsGwS.js";import{i as m,e as p}from"../../vendor_antd-kEHdUJyS.js";import{r as f}from"../../vendor_react-DLFB9-kf.js";import{d as i}from"./data-DPYcAOzQ.js";function x(){const[t,n]=f.useState(0);return d(c,{children:[r(s,{}),r(g,{children:i.map((e,o)=>r(h,{name:e.typeName,image:e.imageUrl,setActive:a=>n(a),index:o,active:t},e.typeName))}),r(u,{accordion:!0,children:i[t].listHelpInfo.map(e=>r(m.Panel,{title:e.title,children:r("div",{dangerouslySetInnerHTML:{__html:e.content}})},e.id.toString()))})]})}const g=l.div`
  display: grid;
